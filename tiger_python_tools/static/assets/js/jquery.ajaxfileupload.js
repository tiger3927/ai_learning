...
//        application/x-www-form-urlencoded
        var form = jQuery('<form  action="" method="POST" name="' + formId + '" id="' + formId + '" encoding="multipart/form-data" enctype="multipart/form-data"></form>');
  //      var form = jQuery('<form  action="" method="POST" name="' + formId + '" id="' + formId + '" enctype="multipart/form-data"></form>');
    ...
    ajaxFileUpload: function (s) {
        ...
        try {
            ...
            jQuery('#' + formId).attr('action', s.url);
            jQuery('#' + formId).attr('method', 'POST');
            jQuery('#' + formId).attr('target', frameId);
            jQuery('#' + formId).attr('Content-Type', 'multipart/form-data');
            
            if (form.encoding) {
                jQuery('#' + formId).attr('encoding', 'multipart/form-data');
            }
            else {
